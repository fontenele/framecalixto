...
class Spdf extends pdf{
	/**
	 * Configura a inicialização do relatório
	 */
	...
	*/
	function cabecalho(){
		...
		$this->Image(realpath('.sistema/imagens/logoFrameCalixto3.png'),10,2,10);
		$this->SetFont('Times','B',12);
		$this->Ln(2);
		$this->Cell(0,10,'Modifique o título do cabeçalho em Spdf::cabecalho();',0,0,'C');
		$this->Ln(20);
		$this->Line($this->GetX()-5, $this->lMargin, $this->GetX()-5, $this->rMargin);
