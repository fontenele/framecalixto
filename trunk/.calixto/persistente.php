...
--------------------------------------------------------------
	...
	public function pegarRegistro() {
		if (!is_subclass_of($this->conexao, 'conexao'))
			throw new erroPersistente('Utilização incorreta da persistente! Possívelmente você efetuou uma chamada do método ' . get_class($this) . '::pegarRegistro sem controle de conexão!');
